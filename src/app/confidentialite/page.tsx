...
import { PRIVACY_SECTIONS, PRIVACY_VERSION, PRIVACY_DATE } from "@/lib/privacy";
    ...
    <div className={styles.page}>
      <div className={styles.container}>
        <header className={styles.header}>
          ...
          <h1 className={styles.title}>Politique de Confidentialit&eacute;</h1>
          <p className={styles.meta}>
            Version {PRIVACY_VERSION} &mdash; En vigueur depuis le {PRIVACY_DATE}
          </p>
        ...
        <footer className={styles.footer}>
          <p>Tuatha SAS &mdash; Version {PRIVACY_VERSION} &mdash; {PRIVACY_DATE}</p>
