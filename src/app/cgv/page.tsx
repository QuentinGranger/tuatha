...
import { CGV_SECTIONS, CGV_VERSION, CGV_DATE } from "@/lib/cgv";
    ...
    <div className={styles.page}>
      <div className={styles.container}>
        <header className={styles.header}>
          ...
          <h1 className={styles.title}>Conditions G&eacute;n&eacute;rales de Vente</h1>
          <p className={styles.meta}>
            Version {CGV_VERSION} &mdash; En vigueur depuis le {CGV_DATE}
          </p>
        ...
        <footer className={styles.footer}>
          <p>Tuatha SAS &mdash; Version {CGV_VERSION} &mdash; {CGV_DATE}</p>
