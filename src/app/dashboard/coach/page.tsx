...
export default function CoachDashboardPage() {
  ...
  // Auto-refresh athlete list every 30s so dashboard stays up-to-date
  useEffect(() => {
      ...
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>
            {loading ? "Chargement..." : `${activeCount} athlète${activeCount !== 1 ? "s" : ""} ${statusFilter ? statusLabels[statusFilter]?.toLowerCase() + "s" : ""}`}
          </p>
        </div>
        ...
        <div className={styles.emptyState}>
          {search ? (
            ...
            <>
              ...
              <p className={styles.emptyTitle}>Aucun athlète pour le moment</p>
              <p className={styles.emptyDesc}>Commencez par ajouter votre premier athlète pour gérer son suivi.</p>
              <div className={styles.emptyChecklist}>
                <div className={styles.checkItem}>✓ Ajoutez un athlète avec son sport</div>
                <div className={styles.checkItem}>✓ Notez les blessures et l&apos;état de santé</div>
                <div className={styles.checkItem}>✓ Suivez la progression au fil du temps</div>
              </div>
              <button className={styles.addBtn} onClick={() => setShowAddModal(true)}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>
                Ajouter un athlète
...
const SPORTS_LIST = [
  "Football", "Rugby", "Tennis", "Natation", "Course à pied", "Cyclisme",
  "Basketball", "Handball", "Volleyball", "CrossFit", "Hyrox", "Musculation",
  "Yoga", "Arts martiaux", "Trail", "Triathlon", "Danse", "Escalade",
  "Boxe", "Ski", "Gymnastique",
];
...
const DATA_TRACKING_OPTIONS = [
  ...
  { value: "rpe", label: "RPE (effort perçu)" },
];
      ...
      <div className={styles.modalWizard} onClick={(e) => e.stopPropagation()}>
        ...
        {step === 1 && (
          <div className={styles.modalForm}>
            ...
            <div className={styles.field}>
              ...
              {sport === "__autre__" && (
                <input type="text" value={sportAutre} onChange={(e) => setSportAutre(e.target.value)} placeholder="Précisez le sport..." style={{ marginTop: 6 }} />
              )}
            </div>
            <div className={styles.field}>
              <label>Objectif principal</label>
              <input type="text" value={objectif} onChange={(e) => setObjectif(e.target.value)} placeholder="Ex: reprendre après blessure, perf Hyrox..." />
            </div>
            <div className={styles.field}>
        ...
        {step === 2 && (
          <div className={styles.modalForm}>
            ...
            <div className={styles.field}>
              <label>Blessure / zone sensible</label>
              <input type="text" value={injuryNote} onChange={(e) => setInjuryNote(e.target.value)} placeholder="Ex: tendinite épaule droite, douleur genou..." />
            </div>
            <div className={styles.field}>
    ...
    <>
      ...
      <div className={styles.panel}>
        ...
        {loading ? (
          ...
          <div className={styles.panelLoading}>Athlète introuvable</div>
        ) : (
          <>
            {/* Identity */}
              ...
              {tab === "infos" && (
                <>
                  <div className={styles.panelSection}>
                    ...
                    <EditableRow label="Email" field="contactEmail" value={athlete.contactEmail} placeholder="athlete@email.com" />
                  ...
                  <div className={styles.panelSection}>
                    ...
                    <div className={styles.panelRow}>
                      ...
                      <div className={styles.miniChips}>
                        {(["douleur", "perf", "sante", "nutrition"] as const).map((m) => (
                  ...
                  <div className={styles.panelSection}>
                    <h4 className={styles.panelSectionTitle}>Profil physique</h4>
                    <EditableRow label="Sport" field="sport" value={athlete.sport} placeholder="Football, Tennis..." />
                    ...
                    <EditableRow label="Blessure" field="injuryNote" value={athlete.injuryNote} placeholder="Tendinite épaule..." />
