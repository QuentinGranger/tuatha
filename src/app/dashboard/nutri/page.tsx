      ...
      <div className={styles.filters}>
        <div className={styles.searchWrapper}>
          ...
          <input
            ...
            placeholder="Rechercher par nom ou profil alimentaire..."
            value={search}
        ...
        <div className={styles.emptyState}>
          {search ? (
            ...
            <>
              ...
              <p className={styles.emptyDesc}>Commencez par ajouter votre premier patient pour gérer son suivi nutritionnel.</p>
              <div className={styles.emptyChecklist}>
                <div className={styles.checkItem}>✓ Ajoutez un patient avec son profil alimentaire</div>
                <div className={styles.checkItem}>✓ Définissez les objectifs et habitudes alimentaires</div>
                <div className={styles.checkItem}>✓ Suivez l&apos;évolution nutritionnelle au fil du temps</div>
              </div>
              <button className={styles.addBtn} onClick={() => setShowAddModal(true)}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>
                Ajouter un patient
                      ...
                      <div className={styles.menuWrapper}>
                        ...
                        {actionMenu === a.id && (
                          <div ref={actionMenuRef} className={styles.menuDropdown} style={{ position: 'fixed', top: menuPos.top, left: menuPos.left, right: 'auto' }}>
                            ...
                            <div className={styles.menuDivider} />
                            <p className={styles.menuLabel}>État nutritionnel</p>
