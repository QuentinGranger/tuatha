...
export const RETENTION_POLICIES: RetentionPolicy[] = [
  ...
  // ═══════════════════════════════════════════════
  // DONNÉES ATHLÈTES (côté AthleteUser)
  // ═══════════════════════════════════════════════

  {
    model: "athleteProMessage",
    description: "Messages athlète↔pro soft-deleted > 1 an",
    maxDays: 365,
    dateField: "deletedAt",
    scope: { deletedAt: { not: null } },
    category: "communication",
    legalBasis: "RGPD Art. 5(1)(e) — correspondance patient-professionnel supprimée",
  },
  {
    model: "athleteDocument",
    description: "Documents athlète soft-deleted > 3 ans",
    maxDays: 1095,
    dateField: "deletedAt",
    scope: { deletedAt: { not: null } },
    category: "medical",
  ...
  },
  {
    ...
    description: "Données wearables > 3 ans",
    maxDays: 1095,
    dateField: "createdAt",
    category: "medical",
    legalBasis: "RGPD Art. 5(1)(e) — données de santé connectée ; conservation limitée à la finalité du suivi",
  },
  {
    model: "healthAppConnection",
    description: "Connexions santé déconnectées > 6 mois",
    maxDays: 180,
    dateField: "updatedAt",
    scope: { status: "disconnected" },
    category: "operational",
    legalBasis: "RGPD Art. 5(1)(e) — connexions inactives avec tokens résiduels",
  },
  {
    model: "consultationPrep",
    description: "Préparations de consultation > 2 ans",
    maxDays: 730,
    dateField: "createdAt",
    category: "medical",
    legalBasis: "CSP Art. R.1112-7 — données de pré-consultation",
  },
  {
    model: "bookingReminder",
    description: "Rappels de RDV envoyés > 6 mois",
    maxDays: 180,
    dateField: "createdAt",
    scope: { sentAt: { not: null } },
    category: "operational",
    legalBasis: "RGPD Art. 5(1)(e) — données de rappels traités",
  },
  {
    model: "dataAccessRequest",
    description: "Demandes d'accès traitées > 2 ans",
    maxDays: 730,
    dateField: "createdAt",
    scope: { status: { in: ["accepted", "rejected"] } },
    category: "consent",
    legalBasis: "RGPD Art. 7(1) — preuve de gestion du consentement granulaire",
  },
  {
    model: "proAccessLog",
    description: "Logs d'accès professionnel > 1 an",
    maxDays: 365,
    dateField: "createdAt",
    category: "security",
    legalBasis: "RGPD Art. 5(1)(e) — journalisation d'accès ; CNIL recommandation 6 mois à 1 an",
  },
  {
    model: "nutriMeasure",
    description: "Mesures nutritionnelles > 5 ans",
    maxDays: 1825,
    dateField: "createdAt",
    category: "medical",
    legalBasis: "CSP Art. R.1112-7 — données biométriques du suivi patient",
  },
  {
    model: "nutriJournal",
    description: "Journaux alimentaires > 3 ans",
    maxDays: 1095,
    dateField: "createdAt",
    category: "operational",
    legalBasis: "RGPD Art. 5(1)(e) — données de suivi alimentaire",
  },
  {
    model: "medClinicalNote",
    description: "Notes cliniques > 20 ans (obligation légale)",
    maxDays: null,
    dateField: "createdAt",
    category: "medical",
    legalBasis: "CSP Art. R.1112-7 — notes du dossier médical ; conservation 20 ans après dernier contact",
  },
  {
    model: "medVitalEntry",
    description: "Constantes vitales > 5 ans",
    maxDays: 1825,
    dateField: "createdAt",
    category: "medical",
    legalBasis: "CSP Art. R.1112-7 — relevés de constantes vitales du patient",
  },
  {
    model: "medAlert",
    description: "Alertes médicales fermées > 5 ans",
    maxDays: 1825,
    dateField: "createdAt",
    scope: { status: "closed" },
    category: "medical",
    legalBasis: "CSP Art. R.1112-7 — alertes cliniques du dossier médical",
  },
  {
    model: "kineAlert",
    description: "Alertes kiné fermées > 3 ans",
    maxDays: 1095,
    dateField: "createdAt",
    scope: { status: { not: "unread" } },
    category: "medical",
    legalBasis: "RGPD Art. 5(1)(e) — alertes de rééducation traitées",
  },
  {
    model: "nutriAlert",
    description: "Alertes nutrition fermées > 3 ans",
    maxDays: 1095,
    dateField: "createdAt",
    scope: { status: { not: "unread" } },
    category: "medical",
    legalBasis: "RGPD Art. 5(1)(e) — alertes nutritionnelles traitées",
  },
  {
    model: "waitlistEntry",
    description: "Inscriptions liste d'attente inactives > 6 mois",
    maxDays: 180,
    dateField: "createdAt",
    scope: { active: false },
    category: "operational",
    legalBasis: "RGPD Art. 5(1)(e) — données de gestion d'agenda",
  },
  {
    model: "slotAlert",
    description: "Alertes créneau inactives > 6 mois",
    maxDays: 180,
    dateField: "createdAt",
    scope: { active: false },
    category: "operational",
